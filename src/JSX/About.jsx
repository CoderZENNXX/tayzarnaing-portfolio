                    ...
                    {aboutJourney === "coding" && (
                        <>
                            <h1 className="milestone-title milestone-title-1">
                                ...
                                <img src="scratch-logo.png" className="milestone-scratch-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-2">
                                ...
                                <img src="python-logo.png" className="milestone-python-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-3">
                                ...
                                <img src="java-logo.png" className="milestone-java-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-4">
                                ...
                                <img src="html-css-logo.png" className="milestone-html-css-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-5">
                                ...
                                <img src="bootstrap-logo.png" className="milestone-bootstrap-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-6">
                                ...
                                <img src="javascript-logo.png" className="milestone-javascript-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-7">
                                ...
                                <img src="reactjs-logo.png" className="milestone-reactjs-logo milestone-image" />
                            </h1>
                        </>
                    )}
                    {aboutJourney === "academics" && (
                        <>
                            <h1 className="milestone-title milestone-title-1">
                                ...
                                <img src="early-basic-education-icon.png" className="milestone-early-basic-education-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-2">
                                ...
                                <img src="self-english-learning-icon.png" className="milestone-self-english-learning-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-3">
                                ...
                                <img src="middle-school-icon.png" className="milestone-middle-school-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-4">
                                ...
                                <img src="english-language-classes-icon.png" className="milestone-english-language-classes-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-5">
                                ...
                                <img src="high-school-icon.png" className="milestone-high-school-logo milestone-image" />
                            </h1>
                        </>
                    )}
                    {aboutJourney === "contentCreation" && (
                        <>
                            <h1 className="milestone-title milestone-title-1">
                                ...
                                <img src="youtube-logo.png" className="milestone-youtube-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-2">
                                ...
                                <img src="retirement-icon.png" className="milestone-retirement-logo milestone-image" />
                            </h1>
                            <h1 className="milestone-title milestone-title-3">
